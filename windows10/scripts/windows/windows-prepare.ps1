...
Write-OutPut "Turn off power down functions.."
...
Write-OutPut "Creating Ansible inventory file..."
$ip = (Get-WmiObject Win32_NetworkAdapterConfiguration | Where-Object {$_.Ipaddress -like "192*"}).Ipaddress[0]
Out-File -FilePath c:\windows\temp\inventory -InputObject $ip -Encoding ascii